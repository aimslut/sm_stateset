...
commands:
  sm_stateset <variable> <value>
    - registers the variable if it doesn't already exist
    - sets the value for the variable
    - use {empty} as value to hide text (shows a space)
  sm_state_menu
    - opens the variable management menu
  sm_state_remove <variable>
    - removes a variable
  sm_state_enable <variable>
    - enables/shows a variable
  sm_state_disable <variable>
    - disables/hides a variable
  sm_state_move <variable> <x> <y>
    - moves a variable to specific coordinates
  sm_state_align <variable> <left|center|right>
    - changes text alignment
  sm_state_position <variable>
    - outputs the current position as sm_state_move command
  !states (in chat)
    - opens the variable management menu
...
example:
  ...
  ```
  // state display
  alias "text_turnbinds" "sm_stateset binds ^00FF00turnbinds^FFFFFF."
  alias "text_flashes"   "sm_stateset binds ^FF0000flashes^FFFFFF."
